              ...
              <div className="ms-3 position-relative">
                ...
                {showDropdown && (
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, #666 60%, #999 90%)', minWidth: 220, zIndex: 1000, opacity: 0.95}}
                  >
                    <Link to="/account" className="dropdown-item text-white d-flex align-items-center gap-2 py-2" style={{ background: 'none' }} >
                      <i className="bi bi-person" /> Manage My Account
                    </Link>
                    <Link to="/orders" className="dropdown-item text-white d-flex align-items-center gap-2 py-2" style={{ background: 'none' }}>
                      <i className="bi bi-bag" /> My Order
                    </Link>
                    <Link to="/cancellations" className="dropdown-item text-white d-flex align-items-center gap-2 py-2" style={{ background: 'none' }}>
                      <i className="bi bi-x-circle" /> My Cancellations
                    </Link>
                    <Link to="/reviews" className="dropdown-item text-white d-flex align-items-center gap-2 py-2" style={{ background: 'none' }}>
